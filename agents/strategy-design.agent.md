...
handoffs:
  ...
  - label: Update Backlog
    ...
    prompt: "The requirements work above changes the shape of the backlog. Please update GitHub: revise the affected epic milestone and tracking issue, create/close/split the affected task issues, and re-expand any issue whose implementation plan is now stale. Details:"
    send: true
---
